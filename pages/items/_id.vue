   ...
   <main class="container">
    ...
    <section class="details">
      ...
      <fieldset v-if="currentItem.addOns">
        ...
        <AppToast v-if="itemAddedToCart">
          <h4>Item add to cart</h4>
          <p>check out more <nuxt-link to="/restaurant">restaurant</nuxt-link></p>
        </AppToast>
      </fieldset>
    </section>
      ...
      components: {
            ...
            currentItem(){
                ...
                for(let i=0; i < this.fooddata.length; i++){
                    for(let j=0; j < this.fooddata[i].menu.length; j++){
                        if(this.id == this.fooddata[i].menu[j].id){
                            results = this.fooddata[i].menu[j];
                            break;
                        }
                    }
        ...
        methods: {
          addToCart(){
            ...
            this.$store.commit("addToCart", formInput);
          }
        },
        data(){
            return{
